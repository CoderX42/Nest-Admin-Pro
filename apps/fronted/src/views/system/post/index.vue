  ...
  <div class="page-container">
    <el-card class="filter-form">
      <el-form :inline="true" :model="queryParams">
        <el-form-item :label="t('system.post.postName')">
          <el-input v-model="queryParams.name" :placeholder="t('system.post.placeholderName')" clearable @keyup.enter="loadData" />
        </el-form-item>
    ...
    <el-card class="table-wrap">
      <template #header>
        <div class="action-bar">
          <el-button type="primary" :icon="Plus" @click="handleCreate">{{ t('system.post.addPost') }}</el-button>
      ...
      <el-table :data="tableData" v-loading="loading" border>
        ...
        <el-table-column prop="name" :label="t('system.post.postName')" min-width="160" />
        <el-table-column prop="code" :label="t('system.post.postCode')" min-width="160" />
    ...
    <el-dialog v-model="dialogVisible" :title="form.id ? t('system.post.editPost') : t('system.post.addPost')" width="600px">
      <el-form :model="form" label-width="100px" class="dialog-form">
        <el-form-item :label="t('system.post.postName')">
          <el-input v-model="form.name" />
        </el-form-item>
        <el-form-item :label="t('system.post.postCode')">
