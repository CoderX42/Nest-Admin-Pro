...
export class DictController {
  ...
  // Dict Data
  @Get('data/list')
  @RequirePermission('system:dictData:query')
  ...
  @Post('data')
  @RequirePermission('system:dictData:add')
  ...
  @Put('data')
  @RequirePermission('system:dictData:edit')
  ...
  @Delete('data/:id')
  @RequirePermission('system:dictData:remove')
  @HttpCode(200)
